...
@ActiveProfiles("example3")
class StreamingIntoDiskTest {
    ...
    companion object {
        ...
        fun registerProperties(registry: DynamicPropertyRegistry) {
            registry.add("rocksdb.path") { tempDir!!.toAbsolutePath().toString() }
        }
    }

    private val config = KafkaConfig(
        consumerGroupName = "StreamingIntoDiskTest",
